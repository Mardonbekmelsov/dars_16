import 'package:dars_16/pages/page4.dart';
              ...
              children: [
                Row(
                  ...
                  children: [
                    CircleAvatar(
                      radius: index == 0 ? 10 : 5,
                      backgroundColor: index == 0 ? Colors.deepPurple : null,
                    ),
                    const SizedBox(
                      width: 5,
                    ),
                    CircleAvatar(
                      radius: index == 1 ? 10 : 5,
                      backgroundColor: index == 1 ? Colors.deepPurple : null,
                    ),
                    const SizedBox(
                      width: 5,
                    ),
                    CircleAvatar(
                      radius: index == 2 ? 10 : 5,
                      backgroundColor: index == 2 ? Colors.deepPurple : null,
                    )
                  ],
                ),
